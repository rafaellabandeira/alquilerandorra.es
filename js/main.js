// Script principal adaptado del proyecto de referencia

document.addEventListener('DOMContentLoaded', function () {
    console.log('Sitio web Alquiler Andorra cargado');

    // Carrusel
    initCarousel();
    // Calendarios informativos (si existen)
    initCalendars();
    // Menú hamburguesa
    initHamburger();

    // Agregar meta viewport para mobile si no existe
